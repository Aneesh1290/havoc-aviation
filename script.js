document.addEventListener('DOMContentLoaded', () => {
    ...
    if (headerContainer) {
        ...
        mobileBookBtn.href = "https://havocsim.in/book";
        ...
        mobileMenu.innerHTML = `
            <div class="mobile-menu-content">
                ...
                <div class="mobile-nav-actions">
                    <a href="https://havocsim.in/book" class="btn btn-outline" style="margin-bottom: 0.5rem; justify-content: center; border: 2px solid var(--primary-color); color: var(--primary-color);">Book a Demo</a>
